...
$latestDir = Get-ChildItem -Directory -Path .\Infnet_DevOps_23E3_3_Docker_Project_Test\TestResults | Sort-Object LastWriteTime -Descending | Select-Object -First 1
...
if ($latestDir -ne $null) {
    ...
    $baseDirectory = Join-Path -Path (Get-Location) -ChildPath "Infnet_DevOps_23E3_3_Docker_Project_Test"
